...
export default function Gateway() {
  ...
  const handleSubmit = (e) => {
    ...
    if (cleanCode === "docentes_2026") {
      ...
      // Assume it's a class short code
    ...
    <div className="min-h-screen bg-[#050505] flex items-center justify-center p-6 overflow-hidden relative font-sans">
      ...
      <div className="max-w-md w-full relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-1000">
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center p-4 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-[32px] mb-6 shadow-2xl shadow-blue-500/20 ring-1 ring-white/20">
          ...
          <p className="text-slate-400 font-bold text-sm uppercase tracking-[0.2em]">Plataforma de Seguimiento Académico</p>
        </div>

        <div className="bg-slate-900/40 backdrop-blur-2xl border border-white/5 p-10 rounded-[48px] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.5)]">
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="space-y-4">
              <label className="text-[10px] font-black text-slate-500 uppercase tracking-[.25em] ml-2">
                Código de Acceso
              </label>
              <div className="relative group">
                <input
                  ...
                  } rounded-[28px] py-5 px-8 text-white font-black text-lg outline-none transition-all placeholder:text-slate-600 text-center uppercase tracking-widest`}
            ...
            <Button 
              type="submit"
              className="w-full bg-blue-600 hover:bg-blue-500 h-16 rounded-[28px] font-black text-lg shadow-xl shadow-blue-600/20 transition-all active:scale-95 flex items-center justify-center gap-3 border-none ring-1 ring-white/10"
            >
          ...
          <div className="mt-12 pt-8 border-t border-white/5 grid grid-cols-2 gap-4">
            <div className="text-center space-y-2 group cursor-help">
              ...
              <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Docentes</p>
            </div>
            <div className="text-center space-y-2 group cursor-help">
              ...
              <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Estudiantes</p>
            </div>
          </div>
        </div>
