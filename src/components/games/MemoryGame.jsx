...
export default function MemoryGame({ studentId, onExit, onWin, isDuel = false, initialDifficulty = 'easy', onDuelScore }) {
  ...
  const handleWin = () => {
    ...
    const score = Math.max(50, basePoints - time * 5);
  ...
  const saveProgress = async (finalScore, earnedCoins = 5) => {
    ...
    try {
      ...
      console.warn("Error saving Memory progress:", err);
    }
  };
